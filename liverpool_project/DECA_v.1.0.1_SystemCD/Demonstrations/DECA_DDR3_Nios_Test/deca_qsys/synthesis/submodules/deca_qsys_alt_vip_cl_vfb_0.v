...
`timescale 1 ps / 1 ps
module deca_qsys_alt_vip_cl_vfb_0 #(
		...
		parameter EXT_CONTROL_DATA_WIDTH       = 16,
	...
	generate
		...
		begin
			...
			instantiated_with_wrong_parameters_error_see_comment_above
					ext_control_data_width_check ( .error(1'b1) );
		end
