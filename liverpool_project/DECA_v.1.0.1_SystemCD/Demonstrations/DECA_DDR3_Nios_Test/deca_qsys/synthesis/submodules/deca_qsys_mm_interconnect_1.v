...
module deca_qsys_mm_interconnect_1 (
	...
	wire  [83:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [83:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [83:0] cmd_mux_002_src_data;                                                              // cmd_mux_002:src_data -> timer_s1_agent:cp_data
	...
	wire  [84:0] ddr3_status_s1_agent_rf_source_data;                                               // ddr3_status_s1_agent:rf_source_data -> ddr3_status_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] ddr3_status_s1_agent_rsp_fifo_out_data;                                            // ddr3_status_s1_agent_rsp_fifo:out_data -> ddr3_status_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                             // cmd_mux_004:src_valid -> ddr3_status_s1_agent:cp_valid
	wire  [83:0] cmd_mux_004_src_data;                                                              // cmd_mux_004:src_data -> ddr3_status_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                             // ddr3_status_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                           // cmd_mux_004:src_channel -> ddr3_status_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                     // cmd_mux_004:src_startofpacket -> ddr3_status_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                       // cmd_mux_004:src_endofpacket -> ddr3_status_s1_agent:cp_endofpacket
	wire         mm_clock_crossing_bridge_io_m0_agent_cp_valid;                                     // mm_clock_crossing_bridge_io_m0_agent:cp_valid -> router:sink_valid
	wire  [83:0] mm_clock_crossing_bridge_io_m0_agent_cp_data;                                      // mm_clock_crossing_bridge_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [83:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                         // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [83:0] sysid_qsys_control_slave_agent_rp_data;                                            // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [83:0] timer_s1_agent_rp_data;                                                            // timer_s1_agent:rp_data -> router_003:sink_data
	...
	wire         ddr3_status_s1_agent_rp_valid;                                                     // ddr3_status_s1_agent:rp_valid -> router_005:sink_valid
	wire  [83:0] ddr3_status_s1_agent_rp_data;                                                      // ddr3_status_s1_agent:rp_data -> router_005:sink_data
	wire         ddr3_status_s1_agent_rp_ready;                                                     // router_005:sink_ready -> ddr3_status_s1_agent:rp_ready
	wire         ddr3_status_s1_agent_rp_startofpacket;                                             // ddr3_status_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         ddr3_status_s1_agent_rp_endofpacket;                                               // ddr3_status_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [83:0] router_src_data;                                                                   // router:src_data -> mm_clock_crossing_bridge_io_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                                  // mm_clock_crossing_bridge_io_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [4:0] router_src_channel;                                                                // router:src_channel -> mm_clock_crossing_bridge_io_m0_limiter:cmd_sink_channel
	...
	wire  [83:0] mm_clock_crossing_bridge_io_m0_limiter_cmd_src_data;                               // mm_clock_crossing_bridge_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire   [4:0] mm_clock_crossing_bridge_io_m0_limiter_cmd_src_channel;                            // mm_clock_crossing_bridge_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [83:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> mm_clock_crossing_bridge_io_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                                 // mm_clock_crossing_bridge_io_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> mm_clock_crossing_bridge_io_m0_limiter:rsp_sink_channel
	...
	wire  [83:0] mm_clock_crossing_bridge_io_m0_limiter_rsp_src_data;                               // mm_clock_crossing_bridge_io_m0_limiter:rsp_src_data -> mm_clock_crossing_bridge_io_m0_agent:rp_data
	...
	wire   [4:0] mm_clock_crossing_bridge_io_m0_limiter_rsp_src_channel;                            // mm_clock_crossing_bridge_io_m0_limiter:rsp_src_channel -> mm_clock_crossing_bridge_io_m0_agent:rp_channel
	...
	wire  [83:0] cmd_demux_src2_data;                                                               // cmd_demux:src2_data -> crosser:in_data
	...
	wire  [83:0] crosser_out_data;                                                                  // crosser:out_data -> cmd_mux_002:sink0_data
	...
	wire  [83:0] rsp_demux_002_src0_data;                                                           // rsp_demux_002:src0_data -> crosser_001:in_data
	...
	wire  [83:0] crosser_001_out_data;                                                              // crosser_001:out_data -> rsp_mux:sink2_data
	...
	wire   [4:0] mm_clock_crossing_bridge_io_m0_limiter_cmd_valid_data;                             // mm_clock_crossing_bridge_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         ddr3_status_s1_agent_rdata_fifo_src_valid;                                         // ddr3_status_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] ddr3_status_s1_agent_rdata_fifo_src_data;                                          // ddr3_status_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         ddr3_status_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> ddr3_status_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                 // avalon_st_adapter_004:out_0_valid -> ddr3_status_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                  // avalon_st_adapter_004:out_0_data -> ddr3_status_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                 // ddr3_status_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                 // avalon_st_adapter_004:out_0_error -> ddr3_status_s1_agent:rdata_fifo_sink_error
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
