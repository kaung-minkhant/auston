...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DECA.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20000040
SOPC_SYSID_FLAG += --sidp=0x20000040
ELF_PATCH_FLAG  += --sidp 0x20000040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1429701634
SOPC_SYSID_FLAG += --timestamp=1429701634
ELF_PATCH_FLAG  += --timestamp 1429701634
