...
module DECA_QSYS_mm_interconnect_0 (
	...
	wire   [24:0] i2c_opencores_0_avalon_slave_0_agent_m0_address;                                  // i2c_opencores_0_avalon_slave_0_agent:m0_address -> i2c_opencores_0_avalon_slave_0_translator:uav_address
	...
	wire          cmd_mux_004_src_valid;                                                            // cmd_mux_004:src_valid -> mm_clock_crossing_bridge_s0_agent:cp_valid
	wire  [100:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> mm_clock_crossing_bridge_s0_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                            // mm_clock_crossing_bridge_s0_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> mm_clock_crossing_bridge_s0_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                    // cmd_mux_004:src_startofpacket -> mm_clock_crossing_bridge_s0_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                      // cmd_mux_004:src_endofpacket -> mm_clock_crossing_bridge_s0_agent:cp_endofpacket
	...
	wire  [100:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire          mm_clock_crossing_bridge_s0_agent_rp_valid;                                       // mm_clock_crossing_bridge_s0_agent:rp_valid -> router_006:sink_valid
	wire  [100:0] mm_clock_crossing_bridge_s0_agent_rp_data;                                        // mm_clock_crossing_bridge_s0_agent:rp_data -> router_006:sink_data
	wire          mm_clock_crossing_bridge_s0_agent_rp_ready;                                       // router_006:sink_ready -> mm_clock_crossing_bridge_s0_agent:rp_ready
	wire          mm_clock_crossing_bridge_s0_agent_rp_startofpacket;                               // mm_clock_crossing_bridge_s0_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          mm_clock_crossing_bridge_s0_agent_rp_endofpacket;                                 // mm_clock_crossing_bridge_s0_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [100:0] onchip_memory2_s1_agent_rp_data;                                                  // onchip_memory2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [100:0] rsp_demux_001_src0_data;                                                          // rsp_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [100:0] crosser_002_out_data;                                                             // crosser_002:out_data -> rsp_mux:sink1_data
	...
	wire  [100:0] rsp_demux_003_src0_data;                                                          // rsp_demux_003:src0_data -> crosser_003:in_data
	wire          rsp_demux_003_src0_ready;                                                         // crosser_003:in_ready -> rsp_demux_003:src0_ready
	wire    [5:0] rsp_demux_003_src0_channel;                                                       // rsp_demux_003:src0_channel -> crosser_003:in_channel
	...
	wire  [100:0] crosser_003_out_data;                                                             // crosser_003:out_data -> rsp_mux:sink3_data
	wire          crosser_003_out_ready;                                                            // rsp_mux:sink3_ready -> crosser_003:out_ready
	wire    [5:0] crosser_003_out_channel;                                                          // crosser_003:out_channel -> rsp_mux:sink3_channel
	...
	wire          mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_valid;                           // mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_data;                            // mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_004:in_0_ready -> mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                // avalon_st_adapter_004:out_0_valid -> mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                 // avalon_st_adapter_004:out_0_data -> mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                // mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                // avalon_st_adapter_004:out_0_error -> mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_error
	...
	DECA_QSYS_mm_interconnect_0_router_004 router_007 (
	...
	DECA_QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DECA_QSYS_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (pll_c0_clk),                                  //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
