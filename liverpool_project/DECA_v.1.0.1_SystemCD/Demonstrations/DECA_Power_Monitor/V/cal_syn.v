...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="cal" LPM_CVALUE=06AA LPM_WIDTH=16 result
...
module  cal_lpm_constant
	...
	defparam
		mgl_prim1.cvalue = 16'b0000011010101010,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1667329024,
...
module cal (
	...
	cal_lpm_constant	cal_lpm_constant_component (
				.result (sub_wire0));
