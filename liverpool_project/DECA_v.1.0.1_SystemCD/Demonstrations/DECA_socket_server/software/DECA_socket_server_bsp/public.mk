...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DECA_socket_server.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DECA_Qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DECA_Qsys
SOPC_NAME := DECA_Qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x200000d0
SOPC_SYSID_FLAG += --sidp=0x200000d0
ELF_PATCH_FLAG  += --sidp 0x200000d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1434619837
SOPC_SYSID_FLAG += --timestamp=1434619837
ELF_PATCH_FLAG  += --timestamp 1434619837
