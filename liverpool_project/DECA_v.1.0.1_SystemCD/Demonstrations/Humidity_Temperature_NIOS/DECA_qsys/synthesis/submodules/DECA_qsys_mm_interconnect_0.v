...
module DECA_qsys_mm_interconnect_0 (
		...
		output wire [6:0]  mm_clock_crossing_bridge_io_s0_address,                           //                             mm_clock_crossing_bridge_io_s0.address
	...
	wire         cmd_mux_src_valid;                                                                // cmd_mux:src_valid -> nios2_gen2_debug_mem_slave_agent:cp_valid
	wire  [98:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> nios2_gen2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // nios2_gen2_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                        // cmd_mux:src_startofpacket -> nios2_gen2_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                          // cmd_mux:src_endofpacket -> nios2_gen2_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [98:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> altpll_0_pll_slave_agent:cp_data
	...
	wire  [24:0] mm_clock_crossing_bridge_io_s0_agent_m0_address;                                  // mm_clock_crossing_bridge_io_s0_agent:m0_address -> mm_clock_crossing_bridge_io_s0_translator:uav_address
	...
	wire  [99:0] mm_clock_crossing_bridge_io_s0_agent_rf_source_data;                              // mm_clock_crossing_bridge_io_s0_agent:rf_source_data -> mm_clock_crossing_bridge_io_s0_agent_rsp_fifo:in_data
	...
	wire  [99:0] mm_clock_crossing_bridge_io_s0_agent_rsp_fifo_out_data;                           // mm_clock_crossing_bridge_io_s0_agent_rsp_fifo:out_data -> mm_clock_crossing_bridge_io_s0_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                            // cmd_mux_002:src_valid -> mm_clock_crossing_bridge_io_s0_agent:cp_valid
	wire  [98:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> mm_clock_crossing_bridge_io_s0_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // mm_clock_crossing_bridge_io_s0_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> mm_clock_crossing_bridge_io_s0_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                    // cmd_mux_002:src_startofpacket -> mm_clock_crossing_bridge_io_s0_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                      // cmd_mux_002:src_endofpacket -> mm_clock_crossing_bridge_io_s0_agent:cp_endofpacket
	...
	wire  [98:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire         nios2_gen2_debug_mem_slave_agent_rp_valid;                                        // nios2_gen2_debug_mem_slave_agent:rp_valid -> router_002:sink_valid
	wire  [98:0] nios2_gen2_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_debug_mem_slave_agent:rp_data -> router_002:sink_data
	wire         nios2_gen2_debug_mem_slave_agent_rp_ready;                                        // router_002:sink_ready -> nios2_gen2_debug_mem_slave_agent:rp_ready
	wire         nios2_gen2_debug_mem_slave_agent_rp_startofpacket;                                // nios2_gen2_debug_mem_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         nios2_gen2_debug_mem_slave_agent_rp_endofpacket;                                  // nios2_gen2_debug_mem_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [98:0] altpll_0_pll_slave_agent_rp_data;                                                 // altpll_0_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire         mm_clock_crossing_bridge_io_s0_agent_rp_valid;                                    // mm_clock_crossing_bridge_io_s0_agent:rp_valid -> router_004:sink_valid
	wire  [98:0] mm_clock_crossing_bridge_io_s0_agent_rp_data;                                     // mm_clock_crossing_bridge_io_s0_agent:rp_data -> router_004:sink_data
	wire         mm_clock_crossing_bridge_io_s0_agent_rp_ready;                                    // router_004:sink_ready -> mm_clock_crossing_bridge_io_s0_agent:rp_ready
	wire         mm_clock_crossing_bridge_io_s0_agent_rp_startofpacket;                            // mm_clock_crossing_bridge_io_s0_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         mm_clock_crossing_bridge_io_s0_agent_rp_endofpacket;                              // mm_clock_crossing_bridge_io_s0_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [98:0] onchip_memory2_s1_agent_rp_data;                                                  // onchip_memory2_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [98:0] rsp_demux_001_src0_data;                                                          // rsp_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [98:0] crosser_001_out_data;                                                             // crosser_001:out_data -> rsp_mux:sink1_data
	...
	wire         nios2_gen2_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios2_gen2_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] nios2_gen2_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios2_gen2_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         nios2_gen2_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> nios2_gen2_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                    // avalon_st_adapter:out_0_valid -> nios2_gen2_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                     // avalon_st_adapter:out_0_data -> nios2_gen2_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                    // nios2_gen2_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                    // avalon_st_adapter:out_0_error -> nios2_gen2_debug_mem_slave_agent:rdata_fifo_sink_error
	...
	wire         mm_clock_crossing_bridge_io_s0_agent_rdata_fifo_src_valid;                        // mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] mm_clock_crossing_bridge_io_s0_agent_rdata_fifo_src_data;                         // mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         mm_clock_crossing_bridge_io_s0_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_002:in_0_ready -> mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                // avalon_st_adapter_002:out_0_valid -> mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                 // avalon_st_adapter_002:out_0_data -> mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                // mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                // avalon_st_adapter_002:out_0_error -> mm_clock_crossing_bridge_io_s0_agent:rdata_fifo_sink_error
	...
	DECA_qsys_mm_interconnect_0_router_003 router_004 (
	...
	DECA_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                                                  //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_s0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
