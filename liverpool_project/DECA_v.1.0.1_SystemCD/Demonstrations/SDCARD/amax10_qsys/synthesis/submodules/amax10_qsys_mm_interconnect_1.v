// amax10_qsys_mm_interconnect_1.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.1 188 at 2015.01.15.16:57:24

`timescale 1 ps / 1 ps
module amax10_qsys_mm_interconnect_1 (
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> timer_s1_agent:cp_channel
	...
	wire  [84:0] sd_clk_s1_agent_rf_source_data;                                                    // sd_clk_s1_agent:rf_source_data -> sd_clk_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] sd_clk_s1_agent_rsp_fifo_out_data;                                                 // sd_clk_s1_agent_rsp_fifo:out_data -> sd_clk_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_004_src_data;                                                              // cmd_mux_004:src_data -> sd_clk_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                             // sd_clk_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                           // cmd_mux_004:src_channel -> sd_clk_s1_agent:cp_channel
	...
	wire  [84:0] sd_cmd_s1_agent_rf_source_data;                                                    // sd_cmd_s1_agent:rf_source_data -> sd_cmd_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] sd_cmd_s1_agent_rsp_fifo_out_data;                                                 // sd_cmd_s1_agent_rsp_fifo:out_data -> sd_cmd_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_005_src_data;                                                              // cmd_mux_005:src_data -> sd_cmd_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                             // sd_cmd_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                           // cmd_mux_005:src_channel -> sd_cmd_s1_agent:cp_channel
	...
	wire  [84:0] sd_dat_s1_agent_rf_source_data;                                                    // sd_dat_s1_agent:rf_source_data -> sd_dat_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] sd_dat_s1_agent_rsp_fifo_out_data;                                                 // sd_dat_s1_agent_rsp_fifo:out_data -> sd_dat_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_006_src_data;                                                              // cmd_mux_006:src_data -> sd_dat_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                             // sd_dat_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                           // cmd_mux_006:src_channel -> sd_dat_s1_agent:cp_channel
	...
	wire  [83:0] sd_clk_s1_agent_rp_data;                                                           // sd_clk_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [83:0] sd_cmd_s1_agent_rp_data;                                                           // sd_cmd_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [83:0] sd_dat_s1_agent_rp_data;                                                           // sd_dat_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [6:0] router_src_channel;                                                                // router:src_channel -> mm_clock_crossing_bridge_io_m0_limiter:cmd_sink_channel
	...
	wire   [6:0] mm_clock_crossing_bridge_io_m0_limiter_cmd_src_channel;                            // mm_clock_crossing_bridge_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [6:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> mm_clock_crossing_bridge_io_m0_limiter:rsp_sink_channel
	...
	wire   [6:0] mm_clock_crossing_bridge_io_m0_limiter_rsp_src_channel;                            // mm_clock_crossing_bridge_io_m0_limiter:rsp_src_channel -> mm_clock_crossing_bridge_io_m0_agent:rp_channel
	...
	wire   [6:0] mm_clock_crossing_bridge_io_m0_limiter_cmd_valid_data;                             // mm_clock_crossing_bridge_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	amax10_qsys_mm_interconnect_1_router router (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_001 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_002 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_003 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_004 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_005 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_006 (
	...
	amax10_qsys_mm_interconnect_1_router_001 router_007 (
	...
	amax10_qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                                   //        clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (clk_50_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
