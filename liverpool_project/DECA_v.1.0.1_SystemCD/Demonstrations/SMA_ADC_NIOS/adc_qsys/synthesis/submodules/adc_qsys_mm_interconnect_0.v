...
module adc_qsys_mm_interconnect_0 (
		...
		input  wire        clk_adc_10_clk_clk,                                           //                                         clk_adc_10_clk.clk
		input  wire        altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset, // altpll_adc_inclk_interface_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  altpll_adc_pll_slave_address,                                 //                                   altpll_adc_pll_slave.address
		output wire        altpll_adc_pll_slave_write,                                   //                                                       .write
		output wire        altpll_adc_pll_slave_read,                                    //                                                       .read
		input  wire [31:0] altpll_adc_pll_slave_readdata,                                //                                                       .readdata
		output wire [31:0] altpll_adc_pll_slave_writedata,                               //                                                       .writedata
		...
		output wire [6:0]  modular_adc_1_sample_store_csr_address,                       //                         modular_adc_1_sample_store_csr.address
		output wire        modular_adc_1_sample_store_csr_write,                         //                                                       .write
		output wire        modular_adc_1_sample_store_csr_read,                          //                                                       .read
		input  wire [31:0] modular_adc_1_sample_store_csr_readdata,                      //                                                       .readdata
		output wire [31:0] modular_adc_1_sample_store_csr_writedata,                     //                                                       .writedata
		output wire [0:0]  modular_adc_1_sequencer_csr_address,                          //                            modular_adc_1_sequencer_csr.address
		output wire        modular_adc_1_sequencer_csr_write,                            //                                                       .write
		output wire        modular_adc_1_sequencer_csr_read,                             //                                                       .read
		input  wire [31:0] modular_adc_1_sequencer_csr_readdata,                         //                                                       .readdata
		output wire [31:0] modular_adc_1_sequencer_csr_writedata,                        //                                                       .writedata
	...
	wire   [9:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire  [31:0] altpll_adc_pll_slave_agent_m0_readdata;                                           // altpll_adc_pll_slave_translator:uav_readdata -> altpll_adc_pll_slave_agent:m0_readdata
	wire         altpll_adc_pll_slave_agent_m0_waitrequest;                                        // altpll_adc_pll_slave_translator:uav_waitrequest -> altpll_adc_pll_slave_agent:m0_waitrequest
	wire         altpll_adc_pll_slave_agent_m0_debugaccess;                                        // altpll_adc_pll_slave_agent:m0_debugaccess -> altpll_adc_pll_slave_translator:uav_debugaccess
	wire  [18:0] altpll_adc_pll_slave_agent_m0_address;                                            // altpll_adc_pll_slave_agent:m0_address -> altpll_adc_pll_slave_translator:uav_address
	wire   [3:0] altpll_adc_pll_slave_agent_m0_byteenable;                                         // altpll_adc_pll_slave_agent:m0_byteenable -> altpll_adc_pll_slave_translator:uav_byteenable
	wire         altpll_adc_pll_slave_agent_m0_read;                                               // altpll_adc_pll_slave_agent:m0_read -> altpll_adc_pll_slave_translator:uav_read
	wire         altpll_adc_pll_slave_agent_m0_readdatavalid;                                      // altpll_adc_pll_slave_translator:uav_readdatavalid -> altpll_adc_pll_slave_agent:m0_readdatavalid
	wire         altpll_adc_pll_slave_agent_m0_lock;                                               // altpll_adc_pll_slave_agent:m0_lock -> altpll_adc_pll_slave_translator:uav_lock
	wire  [31:0] altpll_adc_pll_slave_agent_m0_writedata;                                          // altpll_adc_pll_slave_agent:m0_writedata -> altpll_adc_pll_slave_translator:uav_writedata
	wire         altpll_adc_pll_slave_agent_m0_write;                                              // altpll_adc_pll_slave_agent:m0_write -> altpll_adc_pll_slave_translator:uav_write
	wire   [2:0] altpll_adc_pll_slave_agent_m0_burstcount;                                         // altpll_adc_pll_slave_agent:m0_burstcount -> altpll_adc_pll_slave_translator:uav_burstcount
	wire         altpll_adc_pll_slave_agent_rf_source_valid;                                       // altpll_adc_pll_slave_agent:rf_source_valid -> altpll_adc_pll_slave_agent_rsp_fifo:in_valid
	wire  [97:0] altpll_adc_pll_slave_agent_rf_source_data;                                        // altpll_adc_pll_slave_agent:rf_source_data -> altpll_adc_pll_slave_agent_rsp_fifo:in_data
	wire         altpll_adc_pll_slave_agent_rf_source_ready;                                       // altpll_adc_pll_slave_agent_rsp_fifo:in_ready -> altpll_adc_pll_slave_agent:rf_source_ready
	wire         altpll_adc_pll_slave_agent_rf_source_startofpacket;                               // altpll_adc_pll_slave_agent:rf_source_startofpacket -> altpll_adc_pll_slave_agent_rsp_fifo:in_startofpacket
	wire         altpll_adc_pll_slave_agent_rf_source_endofpacket;                                 // altpll_adc_pll_slave_agent:rf_source_endofpacket -> altpll_adc_pll_slave_agent_rsp_fifo:in_endofpacket
	wire         altpll_adc_pll_slave_agent_rsp_fifo_out_valid;                                    // altpll_adc_pll_slave_agent_rsp_fifo:out_valid -> altpll_adc_pll_slave_agent:rf_sink_valid
	wire  [97:0] altpll_adc_pll_slave_agent_rsp_fifo_out_data;                                     // altpll_adc_pll_slave_agent_rsp_fifo:out_data -> altpll_adc_pll_slave_agent:rf_sink_data
	wire         altpll_adc_pll_slave_agent_rsp_fifo_out_ready;                                    // altpll_adc_pll_slave_agent:rf_sink_ready -> altpll_adc_pll_slave_agent_rsp_fifo:out_ready
	wire         altpll_adc_pll_slave_agent_rsp_fifo_out_startofpacket;                            // altpll_adc_pll_slave_agent_rsp_fifo:out_startofpacket -> altpll_adc_pll_slave_agent:rf_sink_startofpacket
	wire         altpll_adc_pll_slave_agent_rsp_fifo_out_endofpacket;                              // altpll_adc_pll_slave_agent_rsp_fifo:out_endofpacket -> altpll_adc_pll_slave_agent:rf_sink_endofpacket
	wire         altpll_adc_pll_slave_agent_rdata_fifo_src_valid;                                  // altpll_adc_pll_slave_agent:rdata_fifo_src_valid -> altpll_adc_pll_slave_agent_rdata_fifo:in_valid
	wire  [33:0] altpll_adc_pll_slave_agent_rdata_fifo_src_data;                                   // altpll_adc_pll_slave_agent:rdata_fifo_src_data -> altpll_adc_pll_slave_agent_rdata_fifo:in_data
	wire         altpll_adc_pll_slave_agent_rdata_fifo_src_ready;                                  // altpll_adc_pll_slave_agent_rdata_fifo:in_ready -> altpll_adc_pll_slave_agent:rdata_fifo_src_ready
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> altpll_adc_pll_slave_agent:cp_valid
	wire  [96:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> altpll_adc_pll_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // altpll_adc_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [9:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> altpll_adc_pll_slave_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> altpll_adc_pll_slave_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> altpll_adc_pll_slave_agent:cp_endofpacket
	...
	wire  [96:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire  [18:0] modular_adc_0_sample_store_csr_agent_m0_address;                                  // modular_adc_0_sample_store_csr_agent:m0_address -> modular_adc_0_sample_store_csr_translator:uav_address
	...
	wire  [97:0] modular_adc_0_sample_store_csr_agent_rf_source_data;                              // modular_adc_0_sample_store_csr_agent:rf_source_data -> modular_adc_0_sample_store_csr_agent_rsp_fifo:in_data
	...
	wire  [97:0] modular_adc_0_sample_store_csr_agent_rsp_fifo_out_data;                           // modular_adc_0_sample_store_csr_agent_rsp_fifo:out_data -> modular_adc_0_sample_store_csr_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_006_src_data;                                                             // cmd_mux_006:src_data -> modular_adc_0_sample_store_csr_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                            // modular_adc_0_sample_store_csr_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> modular_adc_0_sample_store_csr_agent:cp_channel
	...
	wire  [31:0] modular_adc_1_sample_store_csr_agent_m0_readdata;                                 // modular_adc_1_sample_store_csr_translator:uav_readdata -> modular_adc_1_sample_store_csr_agent:m0_readdata
	wire         modular_adc_1_sample_store_csr_agent_m0_waitrequest;                              // modular_adc_1_sample_store_csr_translator:uav_waitrequest -> modular_adc_1_sample_store_csr_agent:m0_waitrequest
	wire         modular_adc_1_sample_store_csr_agent_m0_debugaccess;                              // modular_adc_1_sample_store_csr_agent:m0_debugaccess -> modular_adc_1_sample_store_csr_translator:uav_debugaccess
	wire  [18:0] modular_adc_1_sample_store_csr_agent_m0_address;                                  // modular_adc_1_sample_store_csr_agent:m0_address -> modular_adc_1_sample_store_csr_translator:uav_address
	wire   [3:0] modular_adc_1_sample_store_csr_agent_m0_byteenable;                               // modular_adc_1_sample_store_csr_agent:m0_byteenable -> modular_adc_1_sample_store_csr_translator:uav_byteenable
	wire         modular_adc_1_sample_store_csr_agent_m0_read;                                     // modular_adc_1_sample_store_csr_agent:m0_read -> modular_adc_1_sample_store_csr_translator:uav_read
	wire         modular_adc_1_sample_store_csr_agent_m0_readdatavalid;                            // modular_adc_1_sample_store_csr_translator:uav_readdatavalid -> modular_adc_1_sample_store_csr_agent:m0_readdatavalid
	wire         modular_adc_1_sample_store_csr_agent_m0_lock;                                     // modular_adc_1_sample_store_csr_agent:m0_lock -> modular_adc_1_sample_store_csr_translator:uav_lock
	wire  [31:0] modular_adc_1_sample_store_csr_agent_m0_writedata;                                // modular_adc_1_sample_store_csr_agent:m0_writedata -> modular_adc_1_sample_store_csr_translator:uav_writedata
	wire         modular_adc_1_sample_store_csr_agent_m0_write;                                    // modular_adc_1_sample_store_csr_agent:m0_write -> modular_adc_1_sample_store_csr_translator:uav_write
	wire   [2:0] modular_adc_1_sample_store_csr_agent_m0_burstcount;                               // modular_adc_1_sample_store_csr_agent:m0_burstcount -> modular_adc_1_sample_store_csr_translator:uav_burstcount
	wire         modular_adc_1_sample_store_csr_agent_rf_source_valid;                             // modular_adc_1_sample_store_csr_agent:rf_source_valid -> modular_adc_1_sample_store_csr_agent_rsp_fifo:in_valid
	wire  [97:0] modular_adc_1_sample_store_csr_agent_rf_source_data;                              // modular_adc_1_sample_store_csr_agent:rf_source_data -> modular_adc_1_sample_store_csr_agent_rsp_fifo:in_data
	wire         modular_adc_1_sample_store_csr_agent_rf_source_ready;                             // modular_adc_1_sample_store_csr_agent_rsp_fifo:in_ready -> modular_adc_1_sample_store_csr_agent:rf_source_ready
	wire         modular_adc_1_sample_store_csr_agent_rf_source_startofpacket;                     // modular_adc_1_sample_store_csr_agent:rf_source_startofpacket -> modular_adc_1_sample_store_csr_agent_rsp_fifo:in_startofpacket
	wire         modular_adc_1_sample_store_csr_agent_rf_source_endofpacket;                       // modular_adc_1_sample_store_csr_agent:rf_source_endofpacket -> modular_adc_1_sample_store_csr_agent_rsp_fifo:in_endofpacket
	wire         modular_adc_1_sample_store_csr_agent_rsp_fifo_out_valid;                          // modular_adc_1_sample_store_csr_agent_rsp_fifo:out_valid -> modular_adc_1_sample_store_csr_agent:rf_sink_valid
	wire  [97:0] modular_adc_1_sample_store_csr_agent_rsp_fifo_out_data;                           // modular_adc_1_sample_store_csr_agent_rsp_fifo:out_data -> modular_adc_1_sample_store_csr_agent:rf_sink_data
	wire         modular_adc_1_sample_store_csr_agent_rsp_fifo_out_ready;                          // modular_adc_1_sample_store_csr_agent:rf_sink_ready -> modular_adc_1_sample_store_csr_agent_rsp_fifo:out_ready
	wire         modular_adc_1_sample_store_csr_agent_rsp_fifo_out_startofpacket;                  // modular_adc_1_sample_store_csr_agent_rsp_fifo:out_startofpacket -> modular_adc_1_sample_store_csr_agent:rf_sink_startofpacket
	wire         modular_adc_1_sample_store_csr_agent_rsp_fifo_out_endofpacket;                    // modular_adc_1_sample_store_csr_agent_rsp_fifo:out_endofpacket -> modular_adc_1_sample_store_csr_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                            // cmd_mux_007:src_valid -> modular_adc_1_sample_store_csr_agent:cp_valid
	wire  [96:0] cmd_mux_007_src_data;                                                             // cmd_mux_007:src_data -> modular_adc_1_sample_store_csr_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                            // modular_adc_1_sample_store_csr_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                          // cmd_mux_007:src_channel -> modular_adc_1_sample_store_csr_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                    // cmd_mux_007:src_startofpacket -> modular_adc_1_sample_store_csr_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                      // cmd_mux_007:src_endofpacket -> modular_adc_1_sample_store_csr_agent:cp_endofpacket
	...
	wire  [18:0] modular_adc_0_sequencer_csr_agent_m0_address;                                     // modular_adc_0_sequencer_csr_agent:m0_address -> modular_adc_0_sequencer_csr_translator:uav_address
	...
	wire  [97:0] modular_adc_0_sequencer_csr_agent_rf_source_data;                                 // modular_adc_0_sequencer_csr_agent:rf_source_data -> modular_adc_0_sequencer_csr_agent_rsp_fifo:in_data
	...
	wire  [97:0] modular_adc_0_sequencer_csr_agent_rsp_fifo_out_data;                              // modular_adc_0_sequencer_csr_agent_rsp_fifo:out_data -> modular_adc_0_sequencer_csr_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_008_src_data;                                                             // cmd_mux_008:src_data -> modular_adc_0_sequencer_csr_agent:cp_data
	...
	wire  [31:0] modular_adc_1_sequencer_csr_agent_m0_readdata;                                    // modular_adc_1_sequencer_csr_translator:uav_readdata -> modular_adc_1_sequencer_csr_agent:m0_readdata
	wire         modular_adc_1_sequencer_csr_agent_m0_waitrequest;                                 // modular_adc_1_sequencer_csr_translator:uav_waitrequest -> modular_adc_1_sequencer_csr_agent:m0_waitrequest
	wire         modular_adc_1_sequencer_csr_agent_m0_debugaccess;                                 // modular_adc_1_sequencer_csr_agent:m0_debugaccess -> modular_adc_1_sequencer_csr_translator:uav_debugaccess
	wire  [18:0] modular_adc_1_sequencer_csr_agent_m0_address;                                     // modular_adc_1_sequencer_csr_agent:m0_address -> modular_adc_1_sequencer_csr_translator:uav_address
	wire   [3:0] modular_adc_1_sequencer_csr_agent_m0_byteenable;                                  // modular_adc_1_sequencer_csr_agent:m0_byteenable -> modular_adc_1_sequencer_csr_translator:uav_byteenable
	wire         modular_adc_1_sequencer_csr_agent_m0_read;                                        // modular_adc_1_sequencer_csr_agent:m0_read -> modular_adc_1_sequencer_csr_translator:uav_read
	wire         modular_adc_1_sequencer_csr_agent_m0_readdatavalid;                               // modular_adc_1_sequencer_csr_translator:uav_readdatavalid -> modular_adc_1_sequencer_csr_agent:m0_readdatavalid
	wire         modular_adc_1_sequencer_csr_agent_m0_lock;                                        // modular_adc_1_sequencer_csr_agent:m0_lock -> modular_adc_1_sequencer_csr_translator:uav_lock
	wire  [31:0] modular_adc_1_sequencer_csr_agent_m0_writedata;                                   // modular_adc_1_sequencer_csr_agent:m0_writedata -> modular_adc_1_sequencer_csr_translator:uav_writedata
	wire         modular_adc_1_sequencer_csr_agent_m0_write;                                       // modular_adc_1_sequencer_csr_agent:m0_write -> modular_adc_1_sequencer_csr_translator:uav_write
	wire   [2:0] modular_adc_1_sequencer_csr_agent_m0_burstcount;                                  // modular_adc_1_sequencer_csr_agent:m0_burstcount -> modular_adc_1_sequencer_csr_translator:uav_burstcount
	wire         modular_adc_1_sequencer_csr_agent_rf_source_valid;                                // modular_adc_1_sequencer_csr_agent:rf_source_valid -> modular_adc_1_sequencer_csr_agent_rsp_fifo:in_valid
	wire  [97:0] modular_adc_1_sequencer_csr_agent_rf_source_data;                                 // modular_adc_1_sequencer_csr_agent:rf_source_data -> modular_adc_1_sequencer_csr_agent_rsp_fifo:in_data
	wire         modular_adc_1_sequencer_csr_agent_rf_source_ready;                                // modular_adc_1_sequencer_csr_agent_rsp_fifo:in_ready -> modular_adc_1_sequencer_csr_agent:rf_source_ready
	wire         modular_adc_1_sequencer_csr_agent_rf_source_startofpacket;                        // modular_adc_1_sequencer_csr_agent:rf_source_startofpacket -> modular_adc_1_sequencer_csr_agent_rsp_fifo:in_startofpacket
	wire         modular_adc_1_sequencer_csr_agent_rf_source_endofpacket;                          // modular_adc_1_sequencer_csr_agent:rf_source_endofpacket -> modular_adc_1_sequencer_csr_agent_rsp_fifo:in_endofpacket
	wire         modular_adc_1_sequencer_csr_agent_rsp_fifo_out_valid;                             // modular_adc_1_sequencer_csr_agent_rsp_fifo:out_valid -> modular_adc_1_sequencer_csr_agent:rf_sink_valid
	wire  [97:0] modular_adc_1_sequencer_csr_agent_rsp_fifo_out_data;                              // modular_adc_1_sequencer_csr_agent_rsp_fifo:out_data -> modular_adc_1_sequencer_csr_agent:rf_sink_data
	wire         modular_adc_1_sequencer_csr_agent_rsp_fifo_out_ready;                             // modular_adc_1_sequencer_csr_agent:rf_sink_ready -> modular_adc_1_sequencer_csr_agent_rsp_fifo:out_ready
	wire         modular_adc_1_sequencer_csr_agent_rsp_fifo_out_startofpacket;                     // modular_adc_1_sequencer_csr_agent_rsp_fifo:out_startofpacket -> modular_adc_1_sequencer_csr_agent:rf_sink_startofpacket
	wire         modular_adc_1_sequencer_csr_agent_rsp_fifo_out_endofpacket;                       // modular_adc_1_sequencer_csr_agent_rsp_fifo:out_endofpacket -> modular_adc_1_sequencer_csr_agent:rf_sink_endofpacket
	wire         cmd_mux_009_src_valid;                                                            // cmd_mux_009:src_valid -> modular_adc_1_sequencer_csr_agent:cp_valid
	wire  [96:0] cmd_mux_009_src_data;                                                             // cmd_mux_009:src_data -> modular_adc_1_sequencer_csr_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                            // modular_adc_1_sequencer_csr_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> modular_adc_1_sequencer_csr_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                                    // cmd_mux_009:src_startofpacket -> modular_adc_1_sequencer_csr_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                                      // cmd_mux_009:src_endofpacket -> modular_adc_1_sequencer_csr_agent:cp_endofpacket
	...
	wire         altpll_adc_pll_slave_agent_rp_valid;                                              // altpll_adc_pll_slave_agent:rp_valid -> router_005:sink_valid
	wire  [96:0] altpll_adc_pll_slave_agent_rp_data;                                               // altpll_adc_pll_slave_agent:rp_data -> router_005:sink_data
	wire         altpll_adc_pll_slave_agent_rp_ready;                                              // router_005:sink_ready -> altpll_adc_pll_slave_agent:rp_ready
	wire         altpll_adc_pll_slave_agent_rp_startofpacket;                                      // altpll_adc_pll_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         altpll_adc_pll_slave_agent_rp_endofpacket;                                        // altpll_adc_pll_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [96:0] onchip_memory2_s1_agent_rp_data;                                                  // onchip_memory2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [96:0] modular_adc_0_sample_store_csr_agent_rp_data;                                     // modular_adc_0_sample_store_csr_agent:rp_data -> router_008:sink_data
	...
	wire         modular_adc_1_sample_store_csr_agent_rp_valid;                                    // modular_adc_1_sample_store_csr_agent:rp_valid -> router_009:sink_valid
	wire  [96:0] modular_adc_1_sample_store_csr_agent_rp_data;                                     // modular_adc_1_sample_store_csr_agent:rp_data -> router_009:sink_data
	wire         modular_adc_1_sample_store_csr_agent_rp_ready;                                    // router_009:sink_ready -> modular_adc_1_sample_store_csr_agent:rp_ready
	wire         modular_adc_1_sample_store_csr_agent_rp_startofpacket;                            // modular_adc_1_sample_store_csr_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         modular_adc_1_sample_store_csr_agent_rp_endofpacket;                              // modular_adc_1_sample_store_csr_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [96:0] modular_adc_0_sequencer_csr_agent_rp_data;                                        // modular_adc_0_sequencer_csr_agent:rp_data -> router_010:sink_data
	...
	wire         modular_adc_1_sequencer_csr_agent_rp_valid;                                       // modular_adc_1_sequencer_csr_agent:rp_valid -> router_011:sink_valid
	wire  [96:0] modular_adc_1_sequencer_csr_agent_rp_data;                                        // modular_adc_1_sequencer_csr_agent:rp_data -> router_011:sink_data
	wire         modular_adc_1_sequencer_csr_agent_rp_ready;                                       // router_011:sink_ready -> modular_adc_1_sequencer_csr_agent:rp_ready
	wire         modular_adc_1_sequencer_csr_agent_rp_startofpacket;                               // modular_adc_1_sequencer_csr_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         modular_adc_1_sequencer_csr_agent_rp_endofpacket;                                 // modular_adc_1_sequencer_csr_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire   [9:0] router_src_channel;                                                               // router:src_channel -> nios2_gen2_data_master_limiter:cmd_sink_channel
	...
	wire   [9:0] nios2_gen2_data_master_limiter_cmd_src_channel;                                   // nios2_gen2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [9:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_gen2_data_master_limiter:rsp_sink_channel
	...
	wire   [9:0] nios2_gen2_data_master_limiter_rsp_src_channel;                                   // nios2_gen2_data_master_limiter:rsp_src_channel -> nios2_gen2_data_master_agent:rp_channel
	...
	wire   [9:0] router_001_src_channel;                                                           // router_001:src_channel -> nios2_gen2_instruction_master_limiter:cmd_sink_channel
	...
	wire   [9:0] nios2_gen2_instruction_master_limiter_cmd_src_channel;                            // nios2_gen2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [9:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_gen2_instruction_master_limiter:rsp_sink_channel
	...
	wire   [9:0] nios2_gen2_instruction_master_limiter_rsp_src_channel;                            // nios2_gen2_instruction_master_limiter:rsp_src_channel -> nios2_gen2_instruction_master_agent:rp_channel
	...
	wire   [9:0] nios2_gen2_data_master_limiter_cmd_valid_data;                                    // nios2_gen2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [9:0] nios2_gen2_instruction_master_limiter_cmd_valid_data;                             // nios2_gen2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         altpll_adc_pll_slave_agent_rdata_fifo_out_valid;                                  // altpll_adc_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] altpll_adc_pll_slave_agent_rdata_fifo_out_data;                                   // altpll_adc_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire         altpll_adc_pll_slave_agent_rdata_fifo_out_ready;                                  // avalon_st_adapter_003:in_0_ready -> altpll_adc_pll_slave_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> altpll_adc_pll_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> altpll_adc_pll_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // altpll_adc_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> altpll_adc_pll_slave_agent:rdata_fifo_sink_error
	...
	wire         modular_adc_0_sample_store_csr_agent_rdata_fifo_src_valid;                        // modular_adc_0_sample_store_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] modular_adc_0_sample_store_csr_agent_rdata_fifo_src_data;                         // modular_adc_0_sample_store_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         modular_adc_0_sample_store_csr_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_006:in_0_ready -> modular_adc_0_sample_store_csr_agent:rdata_fifo_src_ready
	...
	wire         modular_adc_1_sample_store_csr_agent_rdata_fifo_src_valid;                        // modular_adc_1_sample_store_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] modular_adc_1_sample_store_csr_agent_rdata_fifo_src_data;                         // modular_adc_1_sample_store_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         modular_adc_1_sample_store_csr_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_007:in_0_ready -> modular_adc_1_sample_store_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                // avalon_st_adapter_007:out_0_valid -> modular_adc_1_sample_store_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                 // avalon_st_adapter_007:out_0_data -> modular_adc_1_sample_store_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                // modular_adc_1_sample_store_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                // avalon_st_adapter_007:out_0_error -> modular_adc_1_sample_store_csr_agent:rdata_fifo_sink_error
	wire         modular_adc_0_sequencer_csr_agent_rdata_fifo_src_valid;                           // modular_adc_0_sequencer_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] modular_adc_0_sequencer_csr_agent_rdata_fifo_src_data;                            // modular_adc_0_sequencer_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         modular_adc_0_sequencer_csr_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_008:in_0_ready -> modular_adc_0_sequencer_csr_agent:rdata_fifo_src_ready
	...
	wire         modular_adc_1_sequencer_csr_agent_rdata_fifo_src_valid;                           // modular_adc_1_sequencer_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] modular_adc_1_sequencer_csr_agent_rdata_fifo_src_data;                            // modular_adc_1_sequencer_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         modular_adc_1_sequencer_csr_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_009:in_0_ready -> modular_adc_1_sequencer_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                                // avalon_st_adapter_009:out_0_valid -> modular_adc_1_sequencer_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                                 // avalon_st_adapter_009:out_0_data -> modular_adc_1_sequencer_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                                // modular_adc_1_sequencer_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                                // avalon_st_adapter_009:out_0_error -> modular_adc_1_sequencer_csr_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) altpll_adc_pll_slave_translator (
		.clk                    (clk_adc_10_clk_clk),                                           //                      clk.clk
		.reset                  (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (altpll_adc_pll_slave_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (altpll_adc_pll_slave_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (altpll_adc_pll_slave_agent_m0_read),                           //                         .read
		.uav_write              (altpll_adc_pll_slave_agent_m0_write),                          //                         .write
		.uav_waitrequest        (altpll_adc_pll_slave_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (altpll_adc_pll_slave_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (altpll_adc_pll_slave_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (altpll_adc_pll_slave_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (altpll_adc_pll_slave_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (altpll_adc_pll_slave_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (altpll_adc_pll_slave_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (altpll_adc_pll_slave_address),                                 //      avalon_anti_slave_0.address
		.av_write               (altpll_adc_pll_slave_write),                                   //                         .write
		.av_read                (altpll_adc_pll_slave_read),                                    //                         .read
		.av_readdata            (altpll_adc_pll_slave_readdata),                                //                         .readdata
		.av_writedata           (altpll_adc_pll_slave_writedata),                               //                         .writedata
		.av_begintransfer       (),                                                             //              (terminated)
		.av_beginbursttransfer  (),                                                             //              (terminated)
		.av_burstcount          (),                                                             //              (terminated)
		.av_byteenable          (),                                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) modular_adc_1_sample_store_csr_translator (
		.clk                    (clk_50_clk_clk),                                        //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset),           //                    reset.reset
		.uav_address            (modular_adc_1_sample_store_csr_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (modular_adc_1_sample_store_csr_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (modular_adc_1_sample_store_csr_agent_m0_read),          //                         .read
		.uav_write              (modular_adc_1_sample_store_csr_agent_m0_write),         //                         .write
		.uav_waitrequest        (modular_adc_1_sample_store_csr_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (modular_adc_1_sample_store_csr_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (modular_adc_1_sample_store_csr_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (modular_adc_1_sample_store_csr_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (modular_adc_1_sample_store_csr_agent_m0_writedata),     //                         .writedata
		.uav_lock               (modular_adc_1_sample_store_csr_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (modular_adc_1_sample_store_csr_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (modular_adc_1_sample_store_csr_address),                //      avalon_anti_slave_0.address
		.av_write               (modular_adc_1_sample_store_csr_write),                  //                         .write
		.av_read                (modular_adc_1_sample_store_csr_read),                   //                         .read
		.av_readdata            (modular_adc_1_sample_store_csr_readdata),               //                         .readdata
		.av_writedata           (modular_adc_1_sample_store_csr_writedata),              //                         .writedata
		.av_begintransfer       (),                                                      //              (terminated)
		.av_beginbursttransfer  (),                                                      //              (terminated)
		.av_burstcount          (),                                                      //              (terminated)
		.av_byteenable          (),                                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) modular_adc_1_sequencer_csr_translator (
		.clk                    (clk_50_clk_clk),                                     //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset),        //                    reset.reset
		.uav_address            (modular_adc_1_sequencer_csr_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (modular_adc_1_sequencer_csr_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (modular_adc_1_sequencer_csr_agent_m0_read),          //                         .read
		.uav_write              (modular_adc_1_sequencer_csr_agent_m0_write),         //                         .write
		.uav_waitrequest        (modular_adc_1_sequencer_csr_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (modular_adc_1_sequencer_csr_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (modular_adc_1_sequencer_csr_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (modular_adc_1_sequencer_csr_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (modular_adc_1_sequencer_csr_agent_m0_writedata),     //                         .writedata
		.uav_lock               (modular_adc_1_sequencer_csr_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (modular_adc_1_sequencer_csr_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (modular_adc_1_sequencer_csr_address),                //      avalon_anti_slave_0.address
		.av_write               (modular_adc_1_sequencer_csr_write),                  //                         .write
		.av_read                (modular_adc_1_sequencer_csr_read),                   //                         .read
		.av_readdata            (modular_adc_1_sequencer_csr_readdata),               //                         .readdata
		.av_writedata           (modular_adc_1_sequencer_csr_writedata),              //                         .writedata
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
		.av_burstcount          (),                                                   //              (terminated)
		.av_byteenable          (),                                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) altpll_adc_pll_slave_agent (
		.clk                     (clk_adc_10_clk_clk),                                           //             clk.clk
		.reset                   (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (altpll_adc_pll_slave_agent_m0_address),                        //              m0.address
		.m0_burstcount           (altpll_adc_pll_slave_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (altpll_adc_pll_slave_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (altpll_adc_pll_slave_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (altpll_adc_pll_slave_agent_m0_lock),                           //                .lock
		.m0_readdata             (altpll_adc_pll_slave_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (altpll_adc_pll_slave_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (altpll_adc_pll_slave_agent_m0_read),                           //                .read
		.m0_waitrequest          (altpll_adc_pll_slave_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (altpll_adc_pll_slave_agent_m0_writedata),                      //                .writedata
		.m0_write                (altpll_adc_pll_slave_agent_m0_write),                          //                .write
		.rp_endofpacket          (altpll_adc_pll_slave_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (altpll_adc_pll_slave_agent_rp_ready),                          //                .ready
		.rp_valid                (altpll_adc_pll_slave_agent_rp_valid),                          //                .valid
		.rp_data                 (altpll_adc_pll_slave_agent_rp_data),                           //                .data
		.rp_startofpacket        (altpll_adc_pll_slave_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (altpll_adc_pll_slave_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (altpll_adc_pll_slave_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (altpll_adc_pll_slave_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (altpll_adc_pll_slave_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (altpll_adc_pll_slave_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (altpll_adc_pll_slave_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (altpll_adc_pll_slave_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (altpll_adc_pll_slave_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (altpll_adc_pll_slave_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (altpll_adc_pll_slave_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (altpll_adc_pll_slave_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (altpll_adc_pll_slave_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (altpll_adc_pll_slave_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) altpll_adc_pll_slave_agent_rsp_fifo (
		.clk               (clk_adc_10_clk_clk),                                           //       clk.clk
		.reset             (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (altpll_adc_pll_slave_agent_rf_source_data),                    //        in.data
		.in_valid          (altpll_adc_pll_slave_agent_rf_source_valid),                   //          .valid
		.in_ready          (altpll_adc_pll_slave_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (altpll_adc_pll_slave_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (altpll_adc_pll_slave_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (altpll_adc_pll_slave_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (altpll_adc_pll_slave_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (altpll_adc_pll_slave_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (altpll_adc_pll_slave_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (altpll_adc_pll_slave_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) altpll_adc_pll_slave_agent_rdata_fifo (
		.clk               (clk_adc_10_clk_clk),                                           //       clk.clk
		.reset             (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (altpll_adc_pll_slave_agent_rdata_fifo_src_data),               //        in.data
		.in_valid          (altpll_adc_pll_slave_agent_rdata_fifo_src_valid),              //          .valid
		.in_ready          (altpll_adc_pll_slave_agent_rdata_fifo_src_ready),              //          .ready
		.out_data          (altpll_adc_pll_slave_agent_rdata_fifo_out_data),               //       out.data
		.out_valid         (altpll_adc_pll_slave_agent_rdata_fifo_out_valid),              //          .valid
		.out_ready         (altpll_adc_pll_slave_agent_rdata_fifo_out_ready),              //          .ready
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) modular_adc_1_sample_store_csr_agent (
		.clk                     (clk_50_clk_clk),                                                  //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),                     //       clk_reset.reset
		.m0_address              (modular_adc_1_sample_store_csr_agent_m0_address),                 //              m0.address
		.m0_burstcount           (modular_adc_1_sample_store_csr_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (modular_adc_1_sample_store_csr_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (modular_adc_1_sample_store_csr_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (modular_adc_1_sample_store_csr_agent_m0_lock),                    //                .lock
		.m0_readdata             (modular_adc_1_sample_store_csr_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (modular_adc_1_sample_store_csr_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (modular_adc_1_sample_store_csr_agent_m0_read),                    //                .read
		.m0_waitrequest          (modular_adc_1_sample_store_csr_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (modular_adc_1_sample_store_csr_agent_m0_writedata),               //                .writedata
		.m0_write                (modular_adc_1_sample_store_csr_agent_m0_write),                   //                .write
		.rp_endofpacket          (modular_adc_1_sample_store_csr_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (modular_adc_1_sample_store_csr_agent_rp_ready),                   //                .ready
		.rp_valid                (modular_adc_1_sample_store_csr_agent_rp_valid),                   //                .valid
		.rp_data                 (modular_adc_1_sample_store_csr_agent_rp_data),                    //                .data
		.rp_startofpacket        (modular_adc_1_sample_store_csr_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (modular_adc_1_sample_store_csr_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (modular_adc_1_sample_store_csr_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (modular_adc_1_sample_store_csr_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (modular_adc_1_sample_store_csr_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (modular_adc_1_sample_store_csr_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),                               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),                               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),                               //                .error
		.rdata_fifo_src_ready    (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) modular_adc_1_sample_store_csr_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                                  //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.in_data           (modular_adc_1_sample_store_csr_agent_rf_source_data),             //        in.data
		.in_valid          (modular_adc_1_sample_store_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (modular_adc_1_sample_store_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (modular_adc_1_sample_store_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (modular_adc_1_sample_store_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (modular_adc_1_sample_store_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                           // (terminated)
		.csr_read          (1'b0),                                                            // (terminated)
		.csr_write         (1'b0),                                                            // (terminated)
		.csr_readdata      (),                                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) modular_adc_1_sequencer_csr_agent (
		.clk                     (clk_50_clk_clk),                                               //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (modular_adc_1_sequencer_csr_agent_m0_address),                 //              m0.address
		.m0_burstcount           (modular_adc_1_sequencer_csr_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (modular_adc_1_sequencer_csr_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (modular_adc_1_sequencer_csr_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (modular_adc_1_sequencer_csr_agent_m0_lock),                    //                .lock
		.m0_readdata             (modular_adc_1_sequencer_csr_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (modular_adc_1_sequencer_csr_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (modular_adc_1_sequencer_csr_agent_m0_read),                    //                .read
		.m0_waitrequest          (modular_adc_1_sequencer_csr_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (modular_adc_1_sequencer_csr_agent_m0_writedata),               //                .writedata
		.m0_write                (modular_adc_1_sequencer_csr_agent_m0_write),                   //                .write
		.rp_endofpacket          (modular_adc_1_sequencer_csr_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (modular_adc_1_sequencer_csr_agent_rp_ready),                   //                .ready
		.rp_valid                (modular_adc_1_sequencer_csr_agent_rp_valid),                   //                .valid
		.rp_data                 (modular_adc_1_sequencer_csr_agent_rp_data),                    //                .data
		.rp_startofpacket        (modular_adc_1_sequencer_csr_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (modular_adc_1_sequencer_csr_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (modular_adc_1_sequencer_csr_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (modular_adc_1_sequencer_csr_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (modular_adc_1_sequencer_csr_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (modular_adc_1_sequencer_csr_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) modular_adc_1_sequencer_csr_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                               //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		.in_data           (modular_adc_1_sequencer_csr_agent_rf_source_data),             //        in.data
		.in_valid          (modular_adc_1_sequencer_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (modular_adc_1_sequencer_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (modular_adc_1_sequencer_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (modular_adc_1_sequencer_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (modular_adc_1_sequencer_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	adc_qsys_mm_interconnect_0_router_004 router_004 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (altpll_adc_pll_slave_agent_rp_ready),                          //      sink.ready
		.sink_valid         (altpll_adc_pll_slave_agent_rp_valid),                          //          .valid
		.sink_data          (altpll_adc_pll_slave_agent_rp_data),                           //          .data
		.sink_startofpacket (altpll_adc_pll_slave_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (altpll_adc_pll_slave_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_adc_10_clk_clk),                                           //       clk.clk
		.reset              (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_router_002 router_006 (
	...
	adc_qsys_mm_interconnect_0_router_004 router_007 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_008 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (modular_adc_1_sample_store_csr_agent_rp_ready),         //      sink.ready
		.sink_valid         (modular_adc_1_sample_store_csr_agent_rp_valid),         //          .valid
		.sink_data          (modular_adc_1_sample_store_csr_agent_rp_data),          //          .data
		.sink_startofpacket (modular_adc_1_sample_store_csr_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (modular_adc_1_sample_store_csr_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_50_clk_clk),                                        //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_router_002 router_010 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_011 (
		.sink_ready         (modular_adc_1_sequencer_csr_agent_rp_ready),         //      sink.ready
		.sink_valid         (modular_adc_1_sequencer_csr_agent_rp_valid),         //          .valid
		.sink_data          (modular_adc_1_sequencer_csr_agent_rp_data),          //          .data
		.sink_startofpacket (modular_adc_1_sequencer_csr_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (modular_adc_1_sequencer_csr_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_50_clk_clk),                                     //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_adc_10_clk_clk),                                           //       clk.clk
		.reset              (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (clk_adc_10_clk_clk),                                           //       out_clk.clk
		.out_reset         (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (clk_adc_10_clk_clk),                                           //        in_clk.clk
		.in_reset          (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_adc_10_clk_clk),                                           // in_clk_0.clk
		.in_rst_0_reset (altpll_adc_inclk_interface_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (altpll_adc_pll_slave_agent_rdata_fifo_out_data),               //     in_0.data
		.in_0_valid     (altpll_adc_pll_slave_agent_rdata_fifo_out_valid),              //         .valid
		.in_0_ready     (altpll_adc_pll_slave_agent_rdata_fifo_out_ready),              //         .ready
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                                            // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset),               // in_rst_0.reset
		.in_0_data      (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (modular_adc_1_sample_store_csr_agent_rdata_fifo_src_ready), //         .ready
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset),            // in_rst_0.reset
		.in_0_data      (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (modular_adc_1_sequencer_csr_agent_rdata_fifo_src_ready), //         .ready
